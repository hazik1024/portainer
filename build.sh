...
function build_and_push_images() {
  docker build -t "hazik1024/portainer:$1-${VERSION}" -f build/linux/Dockerfile .
  docker tag  "hazik1024/portainer:$1-${VERSION}" "hazik1024/portainer:$1"
  docker push "hazik1024/portainer:$1-${VERSION}"
  docker push "hazik1024/portainer:$1"
}
